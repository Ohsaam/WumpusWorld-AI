...
logging.getLogger().setLevel('CRITICAL')#sys.argv[4]가 없는 경우에는 로그 레벨을 'CRITICAL'로 설정
seedAv=[8641,6682,6108,5519,7395,3591,4443,8556,9452,1519,1987,7449,8025,9268,8622,4838]
seed=random.choice(seedAv)
interactive = True #interactive 변수는 sys.argv[2]가 "interactive"인 경우 True로 설정
do_suite = False
stud_module = importlib.import_module("ashtabna" + '_ExplorerAgent')
Explorer_class = getattr(stud_module,"ashtabna" + '_ExplorerAgent')
